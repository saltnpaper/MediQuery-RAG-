...
Best-model metric       & \texttt{ndcg@10} \\
\bottomrule
\end{tabular}
\end{table}
...
returned the top 100 candidates; the reranker selected the top 5 from the top 20 FAISS
results.
...
Fine-tuning produced consistent double-digit improvements across every metric. The largest
